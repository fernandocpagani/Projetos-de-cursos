...
const EditParty = () => {
  ...
  return (
    ...
    <form onSubmit={(e) => updateParty(e)}>
      ...
      <label>
        <span>Descrição da festa:</span>
        <textarea placeholder='Conte mais sobre a festa' required
        onChange={(e) => setParty({...party, description: e.target.value})} value={party.description}></textarea>
      </label>
      <label>
        <span>Orçamento:</span>
        <input type="number" placeholder='Quanto você pretende investir?' required
        onChange={(e) => setParty({...party, budget: e.target.value})} value={party.budget} />
      </label>
      <label>
        <span>Imagem:</span>
        <input type="text" placeholder='Insira a URL de uma iagem' required
          ...
          {services.map((service) => (
            <div className="service" key={service._id}>
              ...
              <div className="checkbox-container">
                ...
                onChange={(e) => handleServices(e)} checked={party.services.find((partyService) => 
